...
contract ELONMOON is Context, IBEP20, Ownable {
  ...
  //
    ...
    function deposit(uint256 amount) payable public {
        ...
        require(!claimed[msg.sender], "Tokens already claimed");
        require(ethRaised < 30000 * 10**18, "Fundraising goal reached");
        ...
        if (ethRaised < 3000 * 10**18) {//3000 * 10**18
            ...
            storeCoins[msg.sender] += msg.value * 4500000;
        } else if (ethRaised >= 6000 * 10**18 && ethRaised < 9000 * 10**18) {
            storeCoins[msg.sender] += msg.value * 4000000;
        } else if (ethRaised >= 9000 * 10**18 && ethRaised < 12000 * 10**18) {
            storeCoins[msg.sender] += msg.value * 3800000;
        } else if (ethRaised >= 12000 * 10**18 && ethRaised < 15000 * 10**18) {// 
            storeCoins[msg.sender] += msg.value * 3600000;
        } else if (ethRaised >= 15000 * 10**18 && ethRaised < 18000 * 10**18) {// 
            storeCoins[msg.sender] += msg.value * 3400000;
        } else if (ethRaised >= 18000 * 10**18 && ethRaised < 21000 * 10**18) {// 
            storeCoins[msg.sender] += msg.value * 3200000;
        } else if (ethRaised >= 21000 * 10**18 && ethRaised < 30000 * 10**18) {// ... the fundraiser goal
            storeCoins[msg.sender] += msg.value * 3000000;
        }
